...
static struct {
    gpio_type *scn_port; uint16_t scn_pin;
    gpio_type *sda_port; uint16_t sda_pin;
    gpio_type *sck_port; uint16_t sck_pin;
} g_bk = {0};
...
/* Tento obsah prevzaty z bk4819.c (s0v4), upraveny pre AT32F423 */
static uint16_t gGpioOutState;
static Filter selectedFilter = FILTER_OFF;

static const uint16_t modTypeReg47Values[] = {
    [MOD_FM]  = 0, /* BK4819_AF_FM */
    [MOD_AM]  = 4, /* BK4819_AF_AM */
    [MOD_LSB] = 3, /* BK4819_AF_USB */
    [MOD_USB] = 3, /* BK4819_AF_USB */
    [MOD_BYP] = 8, /* BK4819_AF_BYPASS */
    [MOD_RAW] = 5, /* BK4819_AF_RAW */
    [MOD_WFM] = 0, /* BK4819_AF_FM */
};

static const uint8_t sqTypeValues[4] = {0x88, 0xAA, 0xCC, 0xFF};
static const uint8_t DTMF_COEFFS[] = {111, 107, 103, 98, 80, 71, 58, 44, 65, 55, 37, 23, 228, 203, 181, 159};
...
void BK4819_Init(void)
{
    ...
    BK4819_WriteRegister(BK4819_REG_33, 0x9001);
    ...
    BK4819_WriteRegister(0x40, (BK4819_ReadRegister(0x40) & ~(0x7FF)) | (50 * 10) | (1 << 12));
}
...
void BK4819_TuneTo(uint32_t freq, bool precise)
{
    ...
    if (precise) {
        uint32_t n = (uint32_t)BK4819_ReadRegister(BK4819_REG_39) << 16 | BK4819_ReadRegister(BK4819_REG_38);
        BK4819_SetVariableCaliper((int32_t)freq - (int32_t)n);
    }

    if (freq >= 30400000)
        selectedFilter = FILTER_UHF;
    else if (freq >= 24000000)
        selectedFilter = FILTER_VHF;
    else
        selectedFilter = FILTER_OFF;
...
void BK4819_SetFilterBandwidth(BK4819_FilterBandwidth_t bw)
{
    uint16_t val;
    switch (bw) {
        case BK4819_FILTER_BW_6k:  val = 0x2B1; break;
        case BK4819_FILTER_BW_7k:  val = 0x280; break;
        case BK4819_FILTER_BW_9k:  val = 0x24B; break;
        case BK4819_FILTER_BW_10k: val = 0x210; break;
        case BK4819_FILTER_BW_12k: val = 0x1B6; break;
        case BK4819_FILTER_BW_14k: val = 0x173; break;
        case BK4819_FILTER_BW_17k: val = 0x136; break;
        case BK4819_FILTER_BW_20k: val = 0x100; break;
        case BK4819_FILTER_BW_23k: val = 0x0E5; break;
        case BK4819_FILTER_BW_26k: val = 0x0C6; break;
        default: return;
    }
...
{
    BK4819_WriteRegister(BK4819_REG_47, 0x6040 | (modTypeReg47Values[mod] << 8));
}
...
{
    uint16_t v = sq << 8;
    if (openTime) v |= ((openTime & 0x0F) << 4);
    if (closeTime) v |= (closeTime & 0x0F);
...
void BK4819_ToggleAFDAC(bool on)
{
    ...
    if (on) v |= BK4819_REG_30_ENABLE_AF_DAC;
    else    v &= ~BK4819_REG_30_ENABLE_AF_DAC;
...
{
    BK4819_WriteRegister(BK4819_REG_51, BK4819_ReadRegister(BK4819_REG_51) & ~0x8000);
}
...
void BK4819_EnableDTMF(void)
{
    ...
    BK4819_WriteRegister(BK4819_REG_24, BK4819_REG_24_ENABLE | BK4819_REG_24_SELECT_DTMF | 1);
}
...
{
    BK4819_WriteRegister(BK4819_REG_51, BK4819_REG_51_ENABLE_CxCSS | BK4819_REG_51_MODE_CTCSS | (3 << 0));
    BK4819_WriteRegister(BK4819_REG_07, BK4819_REG_07_MODE_CTC1 | scale_freq(freq));
}

void BK4819_SetCDCSSCodeWord(uint32_t codeWord)
{
    BK4819_WriteRegister(BK4819_REG_51, BK4819_REG_51_ENABLE_CxCSS | BK4819_REG_51_MODE_CDCSS | (7 << 0));
...
void BK4819_SetScrambler(uint8_t scrambler)
{
    if (scrambler == 0) {
        ...
        BK4819_WriteRegister(BK4819_REG_48, (BK4819_ReadRegister(BK4819_REG_48) & 0xFFFC) | (scrambler & 3));
...
{
    (void)str; (void)bAuto; (void)first; (void)tick; (void)gap; (void)tail;
}

void BK4819_PlayRogerTiny(void)
{
    BK4819_WriteRegister(BK4819_REG_70, BK4819_REG_70_ENABLE_TONE1 | (10 << 8) | BK4819_REG_70_ENABLE_TONE2 | (10 << 0));
}
